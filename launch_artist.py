"""Entry point for the AI Artist pipeline.
This script mirrors ``launch_scientist.py`` but is tailored for creative
artistic experiments using the same underlying modules.
"""
...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Run AI Artist experiments")
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="sketch_rnn",
        help="Experiment to run AI Artist on.",
    )
    parser.add_argument(
        "--model",
        type=str,
